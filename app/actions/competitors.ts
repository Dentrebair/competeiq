...
/**
 * Run Now — replaces n8n's Manual Trigger. Enqueues the same start_scrape
 * job the competitor's own schedule would fire, immediately.
 *
...
export async function runCompetitorNow(
  ...
  try {
    await enqueue("start_scrape", { competitorId, signalTypes }, { singletonKey: competitorId });
